...
const conversations = [
  {
    niche: "Peluqueria",
    messages: [
      { from: "user", text: "Hola! Quiero sacar un turno para corte" },
      { from: "bot", text: "Hola! Tenemos disponibilidad manana a las 10:00, 14:30 y 17:00. Cual te queda mejor?" },
      { from: "user", text: "14:30 perfecto" },
      { from: "bot", text: "Listo! Turno confirmado para manana a las 14:30. Te envio el recordatorio por aca!" },
    ],
  },
  {
    niche: "Tatuaje",
    messages: [
      { from: "user", text: "Hola, quiero agendar una sesion de tatuaje" },
      { from: "bot", text: "Genial! Tenemos turnos el jueves a las 11:00 y viernes a las 16:00. Cual preferis?" },
      { from: "user", text: "Jueves a las 11" },
      { from: "bot", text: "Perfecto! Sesion agendada para el jueves a las 11:00. Recorda traer la referencia!" },
    ],
  },
  {
    niche: "Dentista",
    messages: [
      { from: "user", text: "Necesito un turno para limpieza dental" },
      { from: "bot", text: "Por supuesto! Hay disponibilidad el lunes a las 9:30 y miercoles a las 15:00. Te sirve?" },
      { from: "user", text: "Lunes a las 9:30" },
      { from: "bot", text: "Confirmado! Turno el lunes a las 9:30 con Dra. Martinez. Te llega el recordatorio!" },
    ],
  },
  {
    niche: "Manicuria",
    messages: [
      { from: "user", text: "Hola! Quiero un turno para semi-permanente" },
      { from: "bot", text: "Hola! Manana hay lugar a las 10:00 y 16:30. Que horario te viene mejor?" },
      { from: "user", text: "16:30 va perfecto" },
      { from: "bot", text: "Agendado! Semi-permanente manana a las 16:30. Nos vemos!" },
    ],
  },
];
...
function WhatsAppMockup() {
  ...
  return (
    <div className="relative">
      {/* iPhone frame */}
      <div className="relative w-[290px] rounded-[50px] bg-gradient-to-b from-[#3A3442] to-[#2C2B33] p-[12px] shadow-2xl">
        ...
        <div className="relative rounded-[40px] overflow-hidden bg-white">
          ...
          {/* Messages */}
          <div className="flex flex-col gap-2 p-3 bg-[#F8F9FC] min-h-[240px]">
            <AnimatePresence mode="wait">
              <motion.div
                key={currentIndex}
                initial={{ opacity: 0 }}
...
function DashboardMockup() {
  return (
    <div className="w-full max-w-[320px] rounded-2xl border border-[#E2E4EC] bg-white shadow-xl shadow-ink/5 ring-1 ring-black/[0.03] overflow-hidden -rotate-1">
      {/* Header */}
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      {/* Timeline / Agenda */}
      <div className="bg-[#F8F9FC] px-4 py-3 relative" style={{ height: 200 }}>
...
export function Hero() {
  return (
    <section className="relative overflow-hidden bg-white">
      <div className="container mx-auto max-w-[1200px] px-6 pb-16 pt-16 md:pb-20 md:pt-24">
        <motion.div
        ...
        >
          ...
          <motion.h1
            variants={fadeUp}
            className="font-display text-3xl md:text-4xl lg:text-5xl leading-tight tracking-tight font-semibold text-text-strong max-w-3xl whitespace-pre-line"
          >
            {hero.headline}
          </motion.h1>
          ...
          <motion.p
            variants={fadeUp}
            className="mt-4 max-w-xl text-body-lg text-gray-medium whitespace-pre-line"
          >
            {hero.subheadline}
          </motion.p>
          ...
          >
            {/* Background glow */}
            <div className="absolute inset-0 -m-12 rounded-3xl bg-gradient-to-b from-surface-cool via-surface-cool/50 to-transparent" />
            {/* Dot grid background */}
            <div className="absolute inset-0 -m-8 dot-grid opacity-40 rounded-3xl" />
            ...
            <div className="relative flex flex-col md:flex-row items-center justify-center gap-6 md:gap-10">
              ...
              <div className="md:hidden text-gray-soft py-1">
